...
use stripe::{Account, AlipayAccount, BankAccount, Card, Currency, Object, PaymentSourceId, Source};
...
impl ft_stripe::Object for stripe::PaymentSource {
